 ...
 */
function charmeem_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'charmeem_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.charmeem-front-page) .entry-title,
...
.colors-custom .charmeem-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.charmeem-front-page .panel-content .recent-posts article,
...
.colors-custom.charmeem-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'charmeem_custom_colors_css', $css, $hue, $saturation );
}
