 ...
 * appear.
 * if latest-post selected then home.php or index.php is used.
 *
 ...
 */
 ...
 <div class = "wrap">
     ...
     <!-- Content is enclosed in container class 'content-area' and comes before sidebar or other widget, this is search engine friendly approach and also makes CSS styling into multiple column easier -->
	...
	if ( 0 !== charmeem_panel_count() || is_customize_preview() ) : // If we have pages to show.
	    ...
	    /**
	    * Filter number of front page sections in Charmeem theme.
	    *
